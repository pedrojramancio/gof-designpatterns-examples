       ...
       System.out.println(
         "interpreting show actor: " + 
          dvdInterpreterClient.interpret(
            "show actor"));
       System.out.println(
          "interpreting show actor for title <training day>: " + 
           dvdInterpreterClient.interpret(
             "show actor for title <Training Day>"));
       System.out.println(
          "interpreting show title: " + 
           dvdInterpreterClient.interpret(
             "show title")); 
       System.out.println(
          "interpreting show title for actor <Ethan Hawke>: " + 
           dvdInterpreterClient.interpret(
             "show title for actor <Ethan Hawke>"));
   }
}      